...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { email: @professor.email, name: @professor.name, surname: @professor.surname, title: @professor.title } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, name: @professor.name, surname: @professor.surname, title: @professor.title } }
