...
class TextsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create text" do
    assert_difference('Text.count') do
      post texts_url, params: { text: { de: @text.de, en: @text.en, fr: @text.fr, sp: @text.sp, tag: @text.tag } }
    end
  ...
  test "should update text" do
    patch text_url(@text), params: { text: { de: @text.de, en: @text.en, fr: @text.fr, sp: @text.sp, tag: @text.tag } }
